  ...
  function Story2sketch(_ref) {
    var _ref$output = _ref.output,
      ...
      standard: {
        ...
        storyKindFilter = _ref.storyKindFilter,
            ...
            switch (_context.prev = _context.next) {
              ...
              case 8:
                ...
                if (this.storyKindFilter) {
                  ...
                  this.storyKindFilter.forEach(function (filter) {
                    filteredStories = filteredStories.concat(_this.stories.filter(function (story) {
                      return story.kind.match(filter);
                    }));
                  });
            ...
            switch (_context2.prev = _context2.next) {
              ...
              case 3:
                ...
                page.on('console', function (msg) {
                  return console.log('PAGE LOG:', msg.text());
                });
                ...
                _loop = function _loop() {
                  ...
                  try {
                    var _loop2 = function _loop2() {
                      ...
                      var storyIndex = _this2.storyCount;
                          ...
                          return _regenerator2.default.wrap(function _callee3$(_context3) {
                            while (1) {
                              switch (_context3.prev = _context3.next) {
                                case 0:
                                  _context3.next = 2;
                                  return _this2.getSymbolsForStory({
                                    page: page,
                                    kind: kind,
                                    story: story
                                  });
                                ...
                                case 2:
                                  ...
                                  for (viewportKey in symbolByViewport) {
                                    ...
                                    _this2.widestByViewport[viewportKey] = Math.max(_this2.widestByViewport[viewportKey] || 0, symbol.frame.width);

                                    // Assign by index to retain the order of the symbols
                                    _this2.symbolsByViewport[viewportKey][storyIndex] = symbol;
                                  }

                                  _this2.tallestByStory[storyIndex] = tallest;
